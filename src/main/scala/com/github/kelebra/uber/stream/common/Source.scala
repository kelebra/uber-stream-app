...
object Twitch extends Source("Twitch", "twitch", "http://player.twitch.tv/?channel=", "dreadztv")

object Hitbox extends Source("Hitbox", "inbox", "http://hitbox.tv/#!/embed/", "wellplay")
